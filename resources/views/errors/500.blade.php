...
<div class="mx-auto max-w-2xl rounded-2xl border border-slate-800 bg-slate-900/80 p-8 text-center shadow-xl">
    <div class="text-sm font-semibold uppercase tracking-wide text-blue-300">Error 500</div>
    <h1 class="mt-3 text-3xl font-bold text-white">Terjadi Kesalahan</h1>
    <p class="mt-3 text-slate-300">Aplikasi mengalami gangguan. Silakan hubungi PIC aplikasi jika masalah berulang.</p>
